...
class Salalahscreen extends StatefulWidget {
  const Salalahscreen({super.key});

  @override
  State<Salalahscreen> createState() => _SalalahscreenState();
}

class _SalalahscreenState extends State<Salalahscreen> {
  List<Court> castleList = [];

  @override
  void initState() {
    super.initState();
    DatabaseHelper.readSala((List<Court> castleList) {
      setState(() {
